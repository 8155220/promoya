package uagrm.promoya.Watson.Conversation;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.navigation_menu_item_chatbot);
        //
...
//            myLogger.info("Sending a message to Watson Conversation Service");
            myLogger.info("enviando un mensaje a watson conversation service");
        ...
        else
        {
            ...
            Toast.makeText(getApplicationContext(),"Presion en el mensaje para grabar sonido",Toast.LENGTH_LONG).show();
    ...
    private void recordMessage() {
        ...
        if(listening != true) {
            ...
            Toast.makeText(ChatBotActivity.this,"Escuchando .... click para detener", Toast.LENGTH_LONG).show();
...
//                Toast.makeText(ChatBotActivity.this,"Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
                Toast.makeText(ChatBotActivity.this,"Escuchador detenido ... click para empezar", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private boolean checkInternetConnection() {
        ...
        if (isConnected){
            ...
            Toast.makeText(this, " No hay conexion a internet disponible ", Toast.LENGTH_LONG).show();
            return false;
        }
